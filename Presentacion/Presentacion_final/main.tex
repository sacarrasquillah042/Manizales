...
\setbeamertemplate{frametitle}{
  \begin{beamercolorbox}[wd=\paperwidth,ht=1.25cm, sep=0.25cm]{frametitle}
    \begin{tikzpicture}[remember picture,overlay]
      ...
      \node[anchor=north east] at (current page.north east) {\includegraphics[height=1cm]{Logos/logoUD.png}};
    \end{tikzpicture}
...
\institute[]{\bigskip
    Universidad Distrital Francisco José de Caldas\\SS
    \bigskip
...
% ==========================================================
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{Fondos/portada.pdf}}
...
% ==========================================================
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{Fondos/Cuerpo.pdf}hjzdbfkdfhaj}
...
%==========================================================
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{Fondos/Cuerpo.pdf}}
...
%=========================3==========================
{
  ...
  \begin{frame}{Teoría de Ginzburg-Landau (1950)}
    ...
    \begin{itemize}
        ...
        \item La amplitud $\lvert \psi\rvert^2$ mide la densidad local de pares de Cooper. La fase $\theta(r)$ contiene toda la información sobre el flujo de supercorriente y la coherencia cuántica.
    \end{itemize}
...
\begin{column}{0.48\textwidth}
      ...
      \begin{column}{0.48\textwidth}
        ...
        \vspace{0.5cm}
        \centering
        \textit{La unión p-n dicipa calor por naturaleza; el diodo de vórtices lo anula.}
      \end{column}
...
% ==========================================================
% SECCIÓN DE BIBLIOGRAFÍA (SIN ARCHIVO .BIB)
% ==========================================================
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{Fondos/Cuerpo.pdf}}
  ...
  % allowframebreaks divide la biblio en varias diapositivas si no cabe
  \begin{frame}[allowframebreaks]{Referencias Bibliográficas}
    \begin{thebibliography}{10}
      \beamertemplatearticlebibitems % Icono de artículo para los papers

      % 1. Kramer & Watts-Tobin (1978)
      \bibitem{kramer1978}
      L. Kramer and R. J. Watts-Tobin (1978).
      \newblock \emph{Theory of Dissipative Current-Carrying States in Superconducting Filaments}.
      \newblock Phys. Rev. Lett. 40, 1041.

      % 2. Aguirre et al. (Meso-wedge)
      \bibitem{aguirre2025}
      C. A. Aguirre, J. Barba-Ortega, et al. (2025).
      \newblock \emph{Superconducting diode effect in a meso-wedge geometry with Abrikosov vortices}.
      \newblock arXiv:2506.01797.

      % 3. Aguirre-Tellez et al. (Voltage Oscillations)
      \bibitem{aguirretellez2024}
      C. Aguirre-Tellez, M. Rincón-Joya and J. Barba-Ortega (2024).
      \newblock \emph{Critical Currents and Voltage Oscillations in a Superconducting Sample}.
      \newblock Rev. UIS Ing. 23(3), 93-98.

      % 4. Nadeem et al. (Review SDE)
      \bibitem{nadeem2023}
      M. Nadeem, M. S. Fuhrer and X. Wang (2023).
      \newblock \emph{Superconducting Diode Effect: Fundamental Concepts and Material Aspects}.
      \newblock arXiv:2301.13564.


      % 7. Bogush et al. (Nanotubes)
      \bibitem{bogush2025}
      I. Bogush, R. H. de Bragança, V. M. Fomin and O. V. Dobrovolskiy (2025).
      \newblock \emph{Vortex Ratchet Effect in Superconductor Open Nanotubes and 3D Nanoflakes}.
      \newblock Phys. Status Solidi RRL.

      % 8. Tinkham (BCS Theory)
      \beamertemplatebookbibitems % Icono de libro
      \bibitem{tinkham1996}
      M. Tinkham (1996).
      \newblock \emph{Introduction to Superconductivity (Chapter 3: The BCS Theory)}.
      \newblock McGraw-Hill.

      % 9. Moysés Luiz (Superconductivity book)
      \bibitem{luiz2011}
      A. Moysés Luiz (Ed.) (2011).
      \newblock \emph{Superconductivity - Theory and Applications}.
      \newblock InTech.

      % 10. Ummarino & Zaccone (Thin Films)
      \beamertemplatearticlebibitems
      \bibitem{ummarino2026}
      G. A. Ummarino and A. Zaccone (2026).
      \newblock \emph{Ginzburg-Landau Theory for Confined Thin-Film Superconductors}.
      \newblock arXiv:2605.10686.
...
% ==========================================================
{
  \usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{Fondos/fin.pdf}}
